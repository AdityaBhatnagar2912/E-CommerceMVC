  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="login"><span class="glyphicon glyphicon-lock"></span> Log in</a></li>
...
<!-- <footer class="container-fluid text-center">
  <form class="form-inline">Get coupons:
    <input type="email" class="form-control" size="50" placeholder="XYZ.....">
    <button type="button" class="btn btn-danger">APPLY COUPONS</button>
  </form>
</footer>
 -->
</body>
